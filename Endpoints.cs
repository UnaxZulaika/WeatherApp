namespace WeatherApp
{
    public class Endpoints
    {
        ...
        public static string GetWeatherEndpoint(float lat, float lon)
        {
            ...
            // var url = $"https://api.open-meteo.com/v1/forecast?latitude=52.5244&longitude=13.4105&current=temperature_2m,weathercode,windspeed_10m,winddirection_10m&hourly=temperature_2m&daily=weathercode,apparent_temperature_max,apparent_temperature_min&timezone=auto";
            return url;
        }
    }
}
